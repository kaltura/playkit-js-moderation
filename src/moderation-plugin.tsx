...
interface ModerationPluginConfig {
  ...
  closeButtonSelectedByDefault: boolean;
}
    ...
    this._moderationOverlay = this._contribServices.overlayManager.add({
      ...
      renderContent: () => (
        <Moderation
          ...
          closeButtonSelectedByDefault={closeButtonSelectedByDefault}
        />
      ),
    });
  };
...
ContribPluginManager.registerPlugin(
  ...
  },
  {
    defaultConfig: {
      ...
      closeButtonSelectedByDefault: false,
      moderateOptions: [
